...
p.seasons <- ggarrange(early2020_AH,
                       ...
                       delta2021_AH,
                       delta2021,
  nrow = 2, ncol = 6, widths = c(1, 2, 1, 2, 1, 2), common.legend = T)
p.seasons


#g <- grid.arrange(allpan_AH, allpan, allpan_border, nrow = 1, widths = c(3, 9, 9))
...
Vacc_HDI <- ggarrange(US_vacc_n + theme(legend.position = "none"), US_vacc_b, 
                      labels = c("A", "B"),
                      common.legend = T, legend = "right",
                      legend.grob = get_legend(US_vacc_b))

ggsave("Plots/Fig_5_Vacc_HDI.png", dpi = 300, height = 8, width = 10)
ggsave("Plots/Fig_5_Vacc_HDI.pdf", dpi = 300, height = 8, width = 10)
...
ggsave("Plots/Fig_6_Vacc_US.png", dpi = 300, height = 8, width = 10)
ggsave("Plots/Fig_6_Vacc_US.pdf", dpi = 300, height = 8, width = 10)
#
```
